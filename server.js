...
io.on("connection", function (socket) {
  ...
  socket.on("reload-table-detail", function (param) {
    ...
    var data2 = {
      ...
      id_floor: param.id_floor,
      id_business: param.id_business,
    };
    ...
    axios
      ...
      .then((res) => {
        ...
        var a = [];
        let list = {
          type_reload: "open_table",
          type_socket: "socket",
          total_table_off: total_off,
          total_table_on: total_on,
          table_status: param.table_status,
          table_title: param.table_title,
          id_floor: param.id_floor,
          id_order: param.id_order,
          id_table: param.id_table,
          ...res.data.data[0],
          table_order: a,
        };
    ...
    if (param.type_manager == "eat-in") {
      ...
      axios
        ...
        .then((res) => {
          if (res.data.data == "") {
            var data_send = {
              message: "remove_order",
              id_order: param.id_order,
              order_type: param.type_manager,
            };
